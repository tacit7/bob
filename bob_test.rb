...
no})
  ...
  def test_only_acronyms
    assert_equal 'Whatever.', teenager.hey('DMV and  NASA')
  end

  def test_yelling_acronyms
    assert_equal 'Woah, chill out!', teenager.hey('DMV AND  NASA!')
  end

  def test_acronyms_and_question
    assert_equal 'Sure.', teenager.hey('DMV and  NASA?')
  end
end
__END__
